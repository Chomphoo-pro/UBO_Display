        ...
        <div class="row">
          ...
          <div class="form-group">
              ...
              <div class="input-group mb-3">
                  ...
                  <input name="mdp" type="text" class="form-control" placeholder="mot de passe" aria-describedby="basic-addon1">
              ...
              <div class="input-group mb-3">
                  ...
                  <input name="mdp_confirme" type="text" class="form-control" placeholder="confirmer mot de passe" aria-describedby="basic-addon1">
