              ...
              */
                            ...
                            if ($numRows > 0) { // Afficher tout
                                ...
                                while ($actualite = $resultat->fetch_assoc()) {
                                    ...
                                    echo '
                                    <span class="col"><a href="#">' . $actualite['ACT_NUMERO'] . '</a></span>
                                    <h2 class="col"><a href="#">' . $actualite['ACT_TITRE'] . '</a></h2>
                                    <p class="col">' . $actualite['ACT_TEXTE'] . '</p>
                                    <span class="col"><a href="#">' . $actualite['CMPT_PSEUDO'] . '</a></span>';
                                    echo '</div>';
                                }
                                echo "</div>";
                ...
                <div class="row">
                    <form action="gestionnaire_actualites_action.php" method="post">

                        <div class="form-group">
                            <div class="input-group mb-3 text-center">

                                <input pattern="[0-9]+" required="required" name="id" type="text" class="form-control" placeholder="saisire ID article" aria-describedby="basic-addon1">

                            </div>
                            
                            <input class="col btn btn-primary" type="submit" value="Supprimer">
                        </div>
